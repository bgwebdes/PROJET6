...
function ccb_widgets_fail_load_out_of_date() {
	...
	$message      = '<p>' . __( 'Elementor CCB Widgets is not working because you are using an old version of Elementor.', 'cost-calculator-builder' ) . '</p>';
	$message     .= '<p>' . sprintf( '<a href="%s" class="button-primary">%s</a>', $upgrade_link, __( 'Update Elementor Now', 'cost-calculator-builder' ) ) . '</p>';
